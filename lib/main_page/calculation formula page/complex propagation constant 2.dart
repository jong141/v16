          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const SizedBox( height: 25),
                Math.tex(r'\varUpsilon =' + variables.real_propagration_constant1_display +r'+' + variables.im_propagration_constant1_display +r'j', textStyle: const TextStyle(fontSize: 25)),
                const SizedBox( height: 25),
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        ExpansionTile(
                          ...
                          children: [
                            ...
                            ListTile(title: Math.tex(r'\ \ \ \ =' +variables.u_display, textStyle: const TextStyle(fontSize: 18)),),
                            ...
                            ListTile(title: Math.tex(r'(' +variables.u_display +r')* (' +variables.real_epsilon_display + r'-' +variables.im_epsilon_display +r'j )',textStyle:const TextStyle(fontSize:18)),),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Polar Magnitude:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(r'\sqrt{ ('+variables.real_epsilon_display +r')^2 +('+variables.neg_im_epsilon_display +r')^2}='+variables.root_R_display , textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ...
                            ListTile(title: Math.tex(r'\large\mu\varepsilon_c\normalsize=' , textStyle: const TextStyle(fontSize: 18))),
                            ListTile(title: Math.tex(r'(' +variables.u_display +r')*('+variables.root_R_display +r'\ \angle' +variables.root_angle_display +r')' , textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Math.tex(r'=' +variables.polar_R_display +r'\ \angle' +variables.root_angle_display , textStyle:const TextStyle(fontSize:18))),
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ...
                        ExpansionTile(
                          ...
                          children: [
                            ListTile(title: Math.tex(r'\large\sqrt{\mu\varepsilon_c}\normalsize='  ,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Math.tex(r' \sqrt{' +variables.polar_R_display +r'\ \angle' +variables.root_angle_display +r'}' ,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ...
                            ListTile(title: Math.tex(r' \sqrt{' +variables.polar_R_display +r'} = ' +variables.root_real_display,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Angle part:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(r'\frac{' +variables.root_angle_display +r'}{2} =' +variables.root_im_display ,textStyle:const TextStyle(fontSize:18))),
                          ],
                        ),
                      ],
                    ),
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ...
                        ListTile(title: Math.tex(r'\ \ \ \ = ' +variables.R_propagration_constant1_display +r'\ \angle'  +variables.angle_propagration_constant1_display,textStyle:const TextStyle(fontSize:18))),
                        ExpansionTile(
                          title: Text("More Details:",
                            style: TextStyle(color: Colors.black, fontSize: 20,),),
                          children: [
                            ListTile(title: Math.tex(r'\varUpsilon = j\large\omega \sqrt{\mu\varepsilon_c}', textStyle: const TextStyle(fontSize: 18))),
                            ListTile(title: Math.tex(r'\ \ \ \ =' +variables.omega_display +r'j * (' +variables.root_real_display +r'\ \angle' +variables.root_im_display +r')' ,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ...
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Polar Magnitude:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(variables.R_jw_display +r'*' +variables.root_real_display +r'=' +variables.R_propagration_constant1_display,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Polar Angle:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(variables.angle_jw_display +r'+' +variables.root_im_display +r'='+variables.angle_propagration_constant1_display, textStyle:const TextStyle(fontSize:18))),
                          ],
                        ),
                      ],
                    ),
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ListTile(title: Math.tex(r'\varUpsilon = j\large\omega \sqrt{\mu\varepsilon_c}', textStyle: const TextStyle(fontSize: 18))),
                        ListTile(title: Math.tex(r'\ \ \ \ = ' +variables.real_propagration_constant1_display +r'+'  +variables.im_propagration_constant1_display +r'j',textStyle:const TextStyle(fontSize:18))),
                        ExpansionTile(
                          title: Text("More Details:",
                            style: TextStyle(color: Colors.black, fontSize: 20,),),
                          children: [
                            ListTile(title: Text.rich(TextSpan(text: 'Covert to Rec form:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(r'\varUpsilon = ' +variables.R_propagration_constant1_display +r'\ \angle'  +variables.angle_propagration_constant1_display, textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Real part:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(variables.R_propagration_constant1_display +r'\large\cos\normalsize(' +variables.angle_propagration_constant1_display +r') = ' +variables.real_propagration_constant1_display,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Imaginary part:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(variables.R_propagration_constant1_display +r'\large\sin\normalsize(' +variables.angle_propagration_constant1_display +r') = ' +variables.im_propagration_constant1_display,textStyle:const TextStyle(fontSize:18))),
                          ],
                        ),
                      ],
                    ),
