          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const SizedBox( height: 25),
                Math.tex(r'\eta_c  =' +variables.g_sqaure_re_display +r'+' +variables.g_sqaure_im_display +r'j' , textStyle: const TextStyle(fontSize: 25)),
                const SizedBox( height: 25),
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        ExpansionTile(
                          ...
                          children: [
                            ...
                            ListTile(title: Math.tex(r'=' +variables.q_real_display +r'\ \angle' +variables.q_angle_display , textStyle:const TextStyle(fontSize:18))),
                          ],
                        ),
                      ],
                    ),
                    ExpansionTile(
                      ...
                      children: [
                        ...
                        ListTile(title: Math.tex(r'\ \ \ \ =' +variables.q_square_real_display +r'\ \angle' +variables.g_square_angle_display, textStyle: const TextStyle(fontSize: 18))),
                        ExpansionTile(
                          title: Text("More Details:",
                            style: TextStyle(color: Colors.black, fontSize: 20,),),
                          children: [
                            ListTile(title: Math.tex(r'\sqrt{\frac{\mu}{\varepsilon_c}}=' ,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Math.tex(r' \sqrt{(' +variables.q_real_display +r')\ \angle' +variables.q_angle_display +r'}' ,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ...
                            ListTile(title: Math.tex(r' \sqrt{' +variables.q_real_display +r'} = ' +variables.q_square_real_display ,textStyle:const TextStyle(fontSize:18))),
                            ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Text.rich(TextSpan(text: 'Angle part:', style: TextStyle(fontSize: 18)))),
                            ListTile(title: Math.tex(r'\frac{' +variables.q_angle_display +r'}{2} =' +variables.g_square_angle_display ,textStyle:const TextStyle(fontSize:18))),
                          ],
                        ),
                      ],
                    ),
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ListTile(title: Math.tex(r'\eta_c = \sqrt{\frac{\mu}{\varepsilon_c}}', textStyle: const TextStyle(fontSize: 18))),
                        ListTile(title: Math.tex(r'\ \ \ \ = ' +variables.g_sqaure_re_display +r'+'  +variables.g_sqaure_im_display +r'j',textStyle:const TextStyle(fontSize:18))),
                        ExpansionTile(
                          title: Text("More Details:",
                            style: TextStyle(color: Colors.black, fontSize: 20,),),
                          children: [
