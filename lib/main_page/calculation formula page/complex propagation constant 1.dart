...
//                         style: TextStyle(color: Colors.black, fontSize: 20,),),
//                       children: [
//                         ListTile(title: Math.tex(r'\varUpsilon =' + variables.a +r'+' +variables.b +r'j' , textStyle: const TextStyle(fontSize: 25))),
//                         ExpansionTile(
//                           title: Text("More Details:",
//                             style: TextStyle(color: Colors.black, fontSize: 20,),),
//                           children: [
//                             ListTile(title: Math.tex(r'\alpha =' +variables.a +r'\ Np/m', textStyle: const TextStyle(fontSize: 22)),),
//                             ListTile(title: Math.tex(r'\beta =' +variables.b +r'\ rad/m',textStyle:const TextStyle(fontSize:22))),
//                           ],
//                         ),
//                       ],
//                     ),
